...
function createFractalWorldsUniforms() {
    ...
    const albedo = loader.load('/textures/lavaAqua.png', undefined, undefined, (err) => console.error('FractalWorlds: lavaAqua load error', err));
    Object.assign(albedo, texOpts);
    const specular = loader.load('/textures/specular01.jpg', undefined, undefined, (err) => console.error('FractalWorlds: specular load error', err));
    Object.assign(specular, texOpts);
    const blueNoise = loader.load('/textures/bluenoise.png', undefined, undefined, (err) => console.error('FractalWorlds: blueNoise load error', err));
...
export const fractalWorldsTheme = {
    id: 'fractal-worlds',
